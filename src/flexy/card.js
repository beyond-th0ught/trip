...
export default function banner() {
  return (
    <div class="px-2 mt- h-full w-full grid grid-cols-3 gap-3">
        <div class=" w-[330px] h-[200px]  mx-3  rounded-3xl bg-white overflow-hidden shadow-sm">
        ...
        <div class=" shadow-sm w-[330px] h-[200px]  mx-3  rounded-3xl bg-white overflow-hidden">
