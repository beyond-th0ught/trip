...
export default function card2page2() {
  return (
    <div class="flex flex-col justify-center items-center ml-5  pt-10">
    <div class="bg-black text-white p-5 px-11 rounded-lg ">
    <h1>Photo/Video</h1>
        <ul>
    ...
    <div class="mt-3">
    <button class="bg-red-500 text-center text-sm text-white py-1 px-11 rounded-md">
            Book Now <br/>
